...
def main():
    # create_pcfg_from_treebank(pickle_it=True, log_it=True, filename="treebank-no-transformations")
    grammar = pickle.load(open("pickled-vars/treebank-no-transformations-grammar.p", "rb"))
    print("Grammar loaded")
    # create_viterbi_parser(grammar, pickle_it=True, filename="viterbi-no-transformations")
